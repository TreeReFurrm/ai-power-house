 ...
 * - NovelCoWriterInput - Input type for the novelCoWriter function.
 * - NovelCoWriterOutput - Output type for the novelCoWriter function.
 */

import {ai} from '@/ai/genkit';
import {z} from 'genkit';

export const NovelCoWriterInputSchema = z.object({
  task: z
...
export type NovelCoWriterInput = z.infer<typeof NovelCoWriterInputSchema>;

export const NovelCoWriterOutputSchema = z.object({
  generatedText: z.string().describe('The resulting text generated by the AI.'),
});
export type NovelCoWriterOutput = z.infer<typeof NovelCoWriterOutputSchema>;
...
export async function novelCoWriter(input: NovelCoWriterInput): Promise<NovelCoWriterOutput> {
