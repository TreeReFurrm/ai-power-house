    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-muted-foreground mt-3 max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-700 [animation-delay:120ms]">
          Your suite of intelligent tools for writing and content creation. Select a tool to get started.
        </p>
        <div className="relative mt-6 max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-700 [animation-delay:240ms]">
          ...
          <input
            ...
            className="w-full rounded-full border border-white/10 bg-card/60 py-2.5 pl-12 pr-4 text-sm text-foreground shadow-[0_0_0_1px_rgba(255,255,255,0.04)] placeholder:text-muted-foreground/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
          />
        </div>
      </div>
      ...
      {recentlyUsedFeatures.length > 0 && (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {recentlyUsedFeatures.map((feature, index) => (
              <ToolCard
                key={feature.href}
                {...feature}
